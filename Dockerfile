...
RUN sed -i "s|https://openaipublic.blob.core.windows.net/gpt-2/encodings/main/vocab.bpe|/python-docker/whisper/vocab.bpe|g" openai_public.py
RUN sed -i "s|https://openaipublic.blob.core.windows.net/gpt-2/encodings/main/encoder.json|/python-docker/whisper/encoder.json|g" openai_public.py
